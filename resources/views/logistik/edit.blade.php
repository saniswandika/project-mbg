...
<form action="{{ route('logistik.update_master_barang', $barang->id) }}" method="POST" enctype="multipart/form-data" id="masterBarangForm">
    @csrf
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <div class="input-group input-group-outline mb-3">
                    {!! Form::text('nama', $barang->nama_barang, ['placeholder' => 'Nama Barang', 'class' => 'form-control']) !!}
                </div>
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <div class="input-group input-group-outline mb-3">
                    {!! Form::text('merk', $barang->merk_barang, ['placeholder' => 'Merk Barang', 'class' => 'form-control']) !!}
                </div>
            </div>
        </div>
                    ...
                    <div class="img-comparison">
                        ...
                        <div>
                            <strong>Foto Sebelumnya:</strong><br>
                                <img src="{{ asset('storage/master_barang/'.$barang->foto) }}" alt="Foto Barang" style="max-height:250px; max-width:500px;" data-image="{{ asset('storage/master_barang/'.$barang->foto) }}">
                        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <div class="input-group input-group-outline mb-3">
                    {!! Form::textarea('deskripsi', $barang->deskripsi, ['placeholder' => 'Deskripsi', 'class' => 'form-control', 'style' => 'height:150px']) !!}
                </div>
            </div>
        </div>
